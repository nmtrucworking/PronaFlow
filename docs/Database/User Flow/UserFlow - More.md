# II. Nghiệp Vụ Tự Động Hóa & Workflow Nâng Cao
Những tính năng này giúp người dùng tiết kiệm thời gian và làm việc thông minh hơn.
## **2. Công Việc Lặp Lại (Recurring Tasks)**
...
## **3. Sự Phụ Thuộc Giữa Các Công Việc (Task Dependencies)**
