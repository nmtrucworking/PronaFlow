...
import { 
  ...
  Layers, Zap, Users, BarChart3, Shield, Globe,
  ArrowRight, Layout, Calendar, Github, Twitter, Linkedin, 
  ArrowUpRight, Sparkles, Rocket, Monitor, Download, 
  Briefcase, Code, Megaphone, Laptop, Book, GraduationCap, 
    ...
    <nav className={cn(
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center gap-2 group cursor-pointer shrink-0">
          <div className="w-9 h-9 bg-indigo-600 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-md group-hover:rotate-3 transition-transform">P</div>
        ...
        <div className="hidden md:flex items-center gap-3">
          <button className="px-4 py-2 text-sm font-bold text-slate-600 hover:text-slate-900 transition-colors">Đăng nhập</button>
          <button className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-lg transition-all shadow-md shadow-indigo-100 hover:-translate-y-0.5">
            Bắt đầu miễn phí
          </button>
        </div>
    ...
    <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          <button className="w-full sm:w-auto px-8 py-4 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl transition-all shadow-xl flex items-center justify-center gap-3 group hover:scale-105 active:scale-95">
            <Download size={20} />
            Tải bản Desktop App
          </button>
          <button className="w-full sm:w-auto px-8 py-4 bg-white border-2 border-slate-100 text-slate-700 hover:bg-slate-50 hover:border-slate-200 font-bold rounded-xl transition-all flex items-center justify-center gap-3 shadow-sm active:scale-95">
            <Globe size={20} />
            Truy cập bản Web
          </button>
        </div>
...
const FeatureSection = () => {
  ...
  return (
    <section id="features" className="bg-white py-12 md:py-20 border-y border-slate-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
          ...
          {/* Right: Sticky Visual */}
          <div className="hidden lg:block h-screen sticky top-0 flex items-center py-20">
        ...
        <div className="bg-slate-900 rounded-[32px] p-10 md:p-20 text-white relative overflow-hidden shadow-2xl">
           ...
           <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                 <button className="w-full sm:w-auto px-10 py-5 bg-indigo-600 hover:bg-indigo-500 text-white font-black rounded-2xl text-xl transition-all shadow-xl shadow-indigo-900/40 hover:-translate-y-1 active:scale-95">
                    Bắt đầu miễn phí
                 </button>
                 <button className="w-full sm:w-auto px-10 py-5 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white font-bold rounded-2xl text-xl border border-white/20 transition-all flex items-center justify-center gap-3">
                    Xem demo live <Play size={20} className="fill-white" />
                 </button>
              </div>
