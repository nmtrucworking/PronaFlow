      ...
      <div className="p-5 flex flex-col flex-1">
        <div className="flex justify-between items-start mb-3">
          <div className="flex items-center gap-2">
             ...
             <span className="text-xs font-mono text-slate-500">{project.key}</span>
          </div>
          <ProjectActionsMenu />
        </div>

        <h3 className="text-base font-bold text-slate-900 mb-2 group-hover:text-indigo-700 line-clamp-2">
          {project.name}
        </h3>
